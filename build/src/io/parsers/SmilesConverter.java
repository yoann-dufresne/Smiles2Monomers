...
public class SmilesConverter {
	...
	public IMolecule transform (String smiles, boolean addHydrogens, boolean calculateCoordinate, boolean expliciteHydrogens) throws InvalidSmilesException {
		IMolecule imol = null;
		try {
			imol = sp.parseSmiles(smiles);
