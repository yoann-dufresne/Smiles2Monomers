...
public class Csv2HTML {
	...
	public static void main(String[] args) {
		...
		PeptideJsonLoader pcl = new PeptideJsonLoader(monoDB);
		...
		System.out.println("--- CSV to HTML ---");
		...
		if (!zip) {
			...
			c2h.createResults(resultDir, imgs, allColors);
		} else {
			// Zip File
			OutputZiper oz = new OutputZiper(outFile);
			//File newName = new File("imgs");
			//imgs.renameTo(newName);
