...
//	}
	 ...
	 *      first pass.
	 */
	private boolean isRingOpening(IAtom a1, List<IAtom> v)
	{
        for (BrokenBond bond : brokenBonds) {
            for (Object aV : v) {
	 ...
	 */
	private List<IAtom> getCanNeigh(final IAtom a, final IAtomContainer container)
	{
	 ...
	 */
	private List<Integer> getRingOpenings(IAtom a, List<IAtom> vbonds)
	{
		Iterator<BrokenBond> it = brokenBonds.iterator();
...
//	}
	 ...
	 */
	private void addAtoms(List<?> v, List<IAtom> result)
	{
        for (Object aV : v) {
	...
	{
		List<Object> tree = new Vector<Object>();
		...
		parseChain(tree, line, atomContainer, null, chiral, doubleBondConfiguration, new Vector<IAtom>(), useAromaticity);
	}
